...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_operation.addWidget(self.b_slash)
        ...
        self.b_slash.clicked.connect(lambda: self._operation("/"))
    ...
    def _button(self, param):
        ...
        if param == '.' and param in line: pass
        else: self.input.setText(line + param)

    def _operation(self, op):
        if self.CanOp and self.input.text() != '.' and self.input.text():
    ...
    def _result(self):
        if not self.CanOp and self.input.text() != '.' and self.input.text():
